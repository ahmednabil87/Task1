...
Console.WriteLine($"Cost :{small * 25 + large * 35:C}");
Console.WriteLine($"Tax :{(small * 25 + large * 35) * .06:C}");
Console.WriteLine("=====================================");
Console.WriteLine($"Total estimate :{small * 25 + large * 35 + (small * 25 + large * 35) * .06:C}");
